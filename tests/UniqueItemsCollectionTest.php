<?php
use Mockery as m;
use Microffice\Core\Support\UniqueItemsCollection as Collection;
...
class SupportCollectionTest extends PHPUnit_Framework_TestCase
{
    ...
    {    
        ...
        $property->setValue($collection, [$item1, $item2]);
    ...
    public function testJsonSerializeCallsToArrayOrJsonSerializeOnEachItemInCollection()
    {
        ...
        $property->setAccessible(true);
        $property->setValue($collection, [$item1, $item2]);
        $results = $collection->jsonSerialize();
    ...
    public function testFlatten()
    {
        ...
        // 
        // Unique Items Collections only allow elements from same type/class
        // 
        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    public function testChunk()
    {
        ...
        $data = $data->chunk(3);
        $this->assertInstanceOf(BaseCollection::class, $data);
    ...
    public function testPluckWithArrayAndObjectValues()
    {
        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        // 
        // NO SUPPORT FOR MIXED ELEMENT TYPES/CLASS :
        // 
        // Unique Items Collections only allow elements from same type/class
        // 
        // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    public function testRejectRemovesElementsPassingTruthTest()
    {
        ...
        $this->assertEquals([[0 => 'foo']], $c->reject([null])->values()->all());
        $c = new Collection(['foo', 'bar']);
    ...
    public function testZip()
    {
        ...
        $this->assertInstanceOf(BaseCollection::class, $c[0]);
        $this->assertInstanceOf(BaseCollection::class, $c[1]);
        $this->assertInstanceOf(BaseCollection::class, $c[2]);
    ...
    {
        if (method_exists(new Collection, 'pipe')) {
